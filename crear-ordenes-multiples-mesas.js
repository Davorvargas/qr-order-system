...
async function crearOrdenesMultiplesMesas() {
  ...
  try {
    ...
    const ordenesPorMesa = [
      ...
      {
        mesa: mesas[1] || mesas[0], // Mesa 2 (o Mesa 1 si no hay Mesa 2)
        ordenes: [
          {
      ...
      {
        mesa: mesas[2] || mesas[0], // Mesa 3 (o Mesa 1 si no hay Mesa 3)
        ordenes: [
          {
      ...
      {
        mesa: mesas[3] || mesas[0], // Mesa 4 (o Mesa 1 si no hay Mesa 4)
        ordenes: [
          {
      ...
      {
        mesa: mesas[4] || mesas[0], // Mesa 5 (o Mesa 1 si no hay Mesa 5)
        ordenes: [
          {
    ...
    for (let mesaIndex = 0; mesaIndex < ordenesPorMesa.length; mesaIndex++) {
      ...
      console.log(`\n🏠 MESA ${mesaData.mesa.table_number} - ${mesaData.mesa.display_name}:`);
